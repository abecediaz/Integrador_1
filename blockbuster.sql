...
INSERT INTO Pelicula (id_peliculas, nombre, genero_principal, descripcion, precio, veces_alquilada, esta_alquilada)
	...
	(4, 'El Quinto Elemento', 'SCIFI', 'Un taxista y una joven se embarcan en una misión para salvar el universo.', 12.00, 3, 1),
	(5, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 3, 0),
	...
	(8, 'Misión Imposible', 'ACCION', 'Ethan Hunt debe limpiar su nombre mientras evita que un grupo terrorista adquiera una bomba nuclear.', 14.75, 6, 1),
	(9, 'El Quinto Elemento', 'SCIFI', 'Un taxista y una joven se embarcan en una misión para salvar el universo.', 12.00, 5, 0),
	...
	(13, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 5, 1),
	...
	(15, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 6, 1),
	(16, 'Misión Imposible', 'ACCION', 'Ethan Hunt debe limpiar su nombre mientras evita que un grupo terrorista adquiera una bomba nuclear.', 14.75, 3, 0),
	...
	(21, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 6, 1),
	(22, 'Titanic', 'ROMANCE', 'El trágico ROMANCE entre Jack y Rose en el fatídico viaje inaugural del Titanic.', 16.00, 4, 1),
	(23, 'El Quinto Elemento', 'SCIFI', 'Un taxista y una joven se embarcan en una misión para salvar el universo.', 12.00, 4, 1),
	...
	(28, 'Misión Imposible', 'ACCION', 'Ethan Hunt debe limpiar su nombre mientras evita que un grupo terrorista adquiera una bomba nuclear.', 14.75, 4, 0),
	...
	(31, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 6, 1),
	(32, 'Matrix', 'SCIFI', 'Un hacker descubre que el mundo que conoce es una simulación controlada por máquinas.', 13.75, 6, 1);